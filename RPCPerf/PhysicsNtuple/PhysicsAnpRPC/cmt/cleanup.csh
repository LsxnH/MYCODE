...
${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PhysicsAnpRPC -version=PhysicsAnpRPC-v1 -path=/home/hengli/testarea/RPCPerf/PhysicsNtuple  $* >${cmtPhysicsAnpRPCtempfile}
if ( $status != 0 ) then
  echo "${CMTROOT}/${CMTBIN}/cmt.exe cleanup -csh -pack=PhysicsAnpRPC -version=PhysicsAnpRPC-v1 -path=/home/hengli/testarea/RPCPerf/PhysicsNtuple  $* >${cmtPhysicsAnpRPCtempfile}"

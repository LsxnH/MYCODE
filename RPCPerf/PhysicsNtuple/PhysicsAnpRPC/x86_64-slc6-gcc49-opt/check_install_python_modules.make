...
#cmt_local_tagfile_check_install_python_modules = $(PhysicsAnpRPC_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(PhysicsAnpRPC_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)PhysicsAnpRPC_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)PhysicsAnpRPCsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.30/AthAnalysisBase/2.4.30/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python *.py ' -installdir=/hepustc/home/hengli/testarea/RPCPerf/InstallArea/python/PhysicsAnpRPC -level=

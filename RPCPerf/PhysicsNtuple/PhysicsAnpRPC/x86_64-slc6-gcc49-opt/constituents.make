...
#cmt_local_tagfile = $(PhysicsAnpRPC_tag).make
cmt_local_tagfile = $(bin)$(PhysicsAnpRPC_tag).make
...
PhysicsAnpRPC_optdebug_library_extratags = -tag_add=target_PhysicsAnpRPC_optdebug_library
...
not_PhysicsAnpRPC_optdebug_library_dependencies = { n=0; for p in $?; do m=0; for d in $(PhysicsAnpRPC_optdebug_library_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PhysicsAnpRPC_optdebug_librarydirs :
	@if test ! -d $(bin)PhysicsAnpRPC_optdebug_library; then $(mkdir) -p $(bin)PhysicsAnpRPC_optdebug_library; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PhysicsAnpRPC_optdebug_library
else
PhysicsAnpRPC_optdebug_librarydirs : ;
endif
...
ifndef QUICK
$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) : $(PhysicsAnpRPC_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_optdebug_library_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library
else
$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) : $(PhysicsAnpRPC_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC_optdebug_library) ] || \
	  $(not_PhysicsAnpRPC_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PhysicsAnpRPC_optdebug_library.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_optdebug_library_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library; \
	  fi
endif
...
$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) : $(PhysicsAnpRPC_optdebug_library_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC_optdebug_library.make"; \
	  $(cmtexe) -f=$(bin)PhysicsAnpRPC_optdebug_library.in -tag=$(tags) $(PhysicsAnpRPC_optdebug_library_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library
else
$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) : $(PhysicsAnpRPC_optdebug_library_dependencies) $(cmt_build_library_linksstamp) $(bin)PhysicsAnpRPC_optdebug_library.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC_optdebug_library) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC_optdebug_library) ] || \
	  $(not_PhysicsAnpRPC_optdebug_library_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_optdebug_library_extratags) build constituent_makefile -out=$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library

PhysicsAnpRPC_optdebug_library :: $(PhysicsAnpRPC_optdebug_library_dependencies) $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) dirs PhysicsAnpRPC_optdebug_librarydirs
	$(echo) "(constituents.make) Starting PhysicsAnpRPC_optdebug_library"
	@if test -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_library
	$(echo) "(constituents.make) PhysicsAnpRPC_optdebug_library done"

clean :: PhysicsAnpRPC_optdebug_libraryclean ;

PhysicsAnpRPC_optdebug_libraryclean :: $(PhysicsAnpRPC_optdebug_libraryclean_dependencies) ##$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting PhysicsAnpRPC_optdebug_libraryclean"
	@-if test -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_libraryclean; \
	fi
	$(echo) "(constituents.make) PhysicsAnpRPC_optdebug_libraryclean done"
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) PhysicsAnpRPC_optdebug_libraryclean

##	  /bin/rm -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) $(bin)PhysicsAnpRPC_optdebug_library_dependencies.make

install :: PhysicsAnpRPC_optdebug_libraryinstall ;

PhysicsAnpRPC_optdebug_libraryinstall :: $(PhysicsAnpRPC_optdebug_library_dependencies) $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) install
...
$(foreach d,$(PhysicsAnpRPC_optdebug_library_dependencies),$(eval $(d)uninstall_dependencies += PhysicsAnpRPC_optdebug_libraryuninstall))

PhysicsAnpRPC_optdebug_libraryuninstall : $(PhysicsAnpRPC_optdebug_libraryuninstall_dependencies) ##$(cmt_local_PhysicsAnpRPC_optdebug_library_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_optdebug_library_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: PhysicsAnpRPC_optdebug_libraryuninstall ;
...
PhysicsAnpRPC_extratags = -tag_add=target_PhysicsAnpRPC
...
not_PhysicsAnpRPC_dependencies = { n=0; for p in $?; do m=0; for d in $(PhysicsAnpRPC_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PhysicsAnpRPCdirs :
	@if test ! -d $(bin)PhysicsAnpRPC; then $(mkdir) -p $(bin)PhysicsAnpRPC; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PhysicsAnpRPC
else
PhysicsAnpRPCdirs : ;
endif
...
ifndef QUICK
$(cmt_local_PhysicsAnpRPC_makefile) : $(PhysicsAnpRPC_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC
else
$(cmt_local_PhysicsAnpRPC_makefile) : $(PhysicsAnpRPC_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC) ] || \
	  $(not_PhysicsAnpRPC_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PhysicsAnpRPC.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC; \
	  fi
endif
...
$(cmt_local_PhysicsAnpRPC_makefile) : $(PhysicsAnpRPC_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC.make"; \
	  $(cmtexe) -f=$(bin)PhysicsAnpRPC.in -tag=$(tags) $(PhysicsAnpRPC_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC
else
$(cmt_local_PhysicsAnpRPC_makefile) : $(PhysicsAnpRPC_dependencies) $(cmt_build_library_linksstamp) $(bin)PhysicsAnpRPC.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC) ] || \
	  $(not_PhysicsAnpRPC_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_extratags) build constituent_makefile -out=$(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC

PhysicsAnpRPC :: $(PhysicsAnpRPC_dependencies) $(cmt_local_PhysicsAnpRPC_makefile) dirs PhysicsAnpRPCdirs
	$(echo) "(constituents.make) Starting PhysicsAnpRPC"
	@if test -f $(cmt_local_PhysicsAnpRPC_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPC
	$(echo) "(constituents.make) PhysicsAnpRPC done"

clean :: PhysicsAnpRPCclean ;

PhysicsAnpRPCclean :: $(PhysicsAnpRPCclean_dependencies) ##$(cmt_local_PhysicsAnpRPC_makefile)
	$(echo) "(constituents.make) Starting PhysicsAnpRPCclean"
	@-if test -f $(cmt_local_PhysicsAnpRPC_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPCclean; \
	fi
	$(echo) "(constituents.make) PhysicsAnpRPCclean done"
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) PhysicsAnpRPCclean

##	  /bin/rm -f $(cmt_local_PhysicsAnpRPC_makefile) $(bin)PhysicsAnpRPC_dependencies.make

install :: PhysicsAnpRPCinstall ;

PhysicsAnpRPCinstall :: $(PhysicsAnpRPC_dependencies) $(cmt_local_PhysicsAnpRPC_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_PhysicsAnpRPC_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(PhysicsAnpRPC_dependencies),$(eval $(d)uninstall_dependencies += PhysicsAnpRPCuninstall))

PhysicsAnpRPCuninstall : $(PhysicsAnpRPCuninstall_dependencies) ##$(cmt_local_PhysicsAnpRPC_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_PhysicsAnpRPC_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: PhysicsAnpRPCuninstall ;
...
cmt_local_tagfile_install_python_modules = $(bin)$(PhysicsAnpRPC_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_PhysicsAnpRPCrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_PhysicsAnpRPCrchk_has_target_tag

cmt_local_tagfile_PhysicsAnpRPCrchk = $(bin)$(PhysicsAnpRPC_tag)_PhysicsAnpRPCrchk.make
cmt_final_setup_PhysicsAnpRPCrchk = $(bin)setup_PhysicsAnpRPCrchk.make
cmt_local_PhysicsAnpRPCrchk_makefile = $(bin)PhysicsAnpRPCrchk.make

PhysicsAnpRPCrchk_extratags = -tag_add=target_PhysicsAnpRPCrchk

else

cmt_local_tagfile_PhysicsAnpRPCrchk = $(bin)$(PhysicsAnpRPC_tag).make
cmt_final_setup_PhysicsAnpRPCrchk = $(bin)setup.make
cmt_local_PhysicsAnpRPCrchk_makefile = $(bin)PhysicsAnpRPCrchk.make

endif

not_PhysicsAnpRPCrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(PhysicsAnpRPCrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PhysicsAnpRPCrchkdirs :
	@if test ! -d $(bin)PhysicsAnpRPCrchk; then $(mkdir) -p $(bin)PhysicsAnpRPCrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PhysicsAnpRPCrchk
else
PhysicsAnpRPCrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_PhysicsAnpRPCrchk_makefile) : $(PhysicsAnpRPCrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPCrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPCrchk_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk
else
$(cmt_local_PhysicsAnpRPCrchk_makefile) : $(PhysicsAnpRPCrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPCrchk) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPCrchk) ] || \
	  $(not_PhysicsAnpRPCrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PhysicsAnpRPCrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPCrchk_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk; \
	  fi
endif
...
$(cmt_local_PhysicsAnpRPCrchk_makefile) : $(PhysicsAnpRPCrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPCrchk.make"; \
	  $(cmtexe) -f=$(bin)PhysicsAnpRPCrchk.in -tag=$(tags) $(PhysicsAnpRPCrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk
else
$(cmt_local_PhysicsAnpRPCrchk_makefile) : $(PhysicsAnpRPCrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)PhysicsAnpRPCrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPCrchk) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPCrchk) ] || \
	  $(not_PhysicsAnpRPCrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPCrchk_extratags) build constituent_makefile -out=$(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk

PhysicsAnpRPCrchk :: $(PhysicsAnpRPCrchk_dependencies) $(cmt_local_PhysicsAnpRPCrchk_makefile) dirs PhysicsAnpRPCrchkdirs
	$(echo) "(constituents.make) Starting PhysicsAnpRPCrchk"
	@if test -f $(cmt_local_PhysicsAnpRPCrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchk
	$(echo) "(constituents.make) PhysicsAnpRPCrchk done"

clean :: PhysicsAnpRPCrchkclean ;

PhysicsAnpRPCrchkclean :: $(PhysicsAnpRPCrchkclean_dependencies) ##$(cmt_local_PhysicsAnpRPCrchk_makefile)
	$(echo) "(constituents.make) Starting PhysicsAnpRPCrchkclean"
	@-if test -f $(cmt_local_PhysicsAnpRPCrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchkclean; \
	fi
	$(echo) "(constituents.make) PhysicsAnpRPCrchkclean done"
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) PhysicsAnpRPCrchkclean

##	  /bin/rm -f $(cmt_local_PhysicsAnpRPCrchk_makefile) $(bin)PhysicsAnpRPCrchk_dependencies.make

install :: PhysicsAnpRPCrchkinstall ;

PhysicsAnpRPCrchkinstall :: $(PhysicsAnpRPCrchk_dependencies) $(cmt_local_PhysicsAnpRPCrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_PhysicsAnpRPCrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : PhysicsAnpRPCrchkuninstall

$(foreach d,$(PhysicsAnpRPCrchk_dependencies),$(eval $(d)uninstall_dependencies += PhysicsAnpRPCrchkuninstall))

PhysicsAnpRPCrchkuninstall : $(PhysicsAnpRPCrchkuninstall_dependencies) ##$(cmt_local_PhysicsAnpRPCrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_PhysicsAnpRPCrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPCrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: PhysicsAnpRPCrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(PhysicsAnpRPC_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(PhysicsAnpRPC_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_make = $(bin)$(PhysicsAnpRPC_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(PhysicsAnpRPC_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(PhysicsAnpRPC_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(PhysicsAnpRPC_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(PhysicsAnpRPC_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(PhysicsAnpRPC_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(PhysicsAnpRPC_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(PhysicsAnpRPC_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(PhysicsAnpRPC_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(PhysicsAnpRPC_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(PhysicsAnpRPC_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(PhysicsAnpRPC_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(PhysicsAnpRPC_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(PhysicsAnpRPC_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_PhysicsAnpRPC_NICOS_Fix_debuginfo_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_PhysicsAnpRPC_NICOS_Fix_debuginfo_has_target_tag

cmt_local_tagfile_PhysicsAnpRPC_NICOS_Fix_debuginfo = $(bin)$(PhysicsAnpRPC_tag)_PhysicsAnpRPC_NICOS_Fix_debuginfo.make
cmt_final_setup_PhysicsAnpRPC_NICOS_Fix_debuginfo = $(bin)setup_PhysicsAnpRPC_NICOS_Fix_debuginfo.make
cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile = $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo.make

PhysicsAnpRPC_NICOS_Fix_debuginfo_extratags = -tag_add=target_PhysicsAnpRPC_NICOS_Fix_debuginfo

else

cmt_local_tagfile_PhysicsAnpRPC_NICOS_Fix_debuginfo = $(bin)$(PhysicsAnpRPC_tag).make
cmt_final_setup_PhysicsAnpRPC_NICOS_Fix_debuginfo = $(bin)setup.make
cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile = $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo.make

endif

not_PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies = { n=0; for p in $?; do m=0; for d in $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
PhysicsAnpRPC_NICOS_Fix_debuginfodirs :
	@if test ! -d $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo; then $(mkdir) -p $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo
else
PhysicsAnpRPC_NICOS_Fix_debuginfodirs : ;
endif
...
ifndef QUICK
$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) : $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo
else
$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) : $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC_NICOS_Fix_debuginfo) ] || \
	  $(not_PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building PhysicsAnpRPC_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_NICOS_Fix_debuginfo_extratags) build constituent_config -out=$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo; \
	  fi
endif
...
$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) : $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) build_library_links
	$(echo) "(constituents.make) Building PhysicsAnpRPC_NICOS_Fix_debuginfo.make"; \
	  $(cmtexe) -f=$(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo.in -tag=$(tags) $(PhysicsAnpRPC_NICOS_Fix_debuginfo_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo
else
$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) : $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) $(cmt_build_library_linksstamp) $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_PhysicsAnpRPC_NICOS_Fix_debuginfo) ] || \
	  [ ! -f $(cmt_final_setup_PhysicsAnpRPC_NICOS_Fix_debuginfo) ] || \
	  $(not_PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(PhysicsAnpRPC_NICOS_Fix_debuginfo_extratags) build constituent_makefile -out=$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo

PhysicsAnpRPC_NICOS_Fix_debuginfo :: $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) dirs PhysicsAnpRPC_NICOS_Fix_debuginfodirs
	$(echo) "(constituents.make) Starting PhysicsAnpRPC_NICOS_Fix_debuginfo"
	@if test -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfo
	$(echo) "(constituents.make) PhysicsAnpRPC_NICOS_Fix_debuginfo done"

clean :: PhysicsAnpRPC_NICOS_Fix_debuginfoclean ;

PhysicsAnpRPC_NICOS_Fix_debuginfoclean :: $(PhysicsAnpRPC_NICOS_Fix_debuginfoclean_dependencies) ##$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting PhysicsAnpRPC_NICOS_Fix_debuginfoclean"
	@-if test -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfoclean; \
	fi
	$(echo) "(constituents.make) PhysicsAnpRPC_NICOS_Fix_debuginfoclean done"
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) PhysicsAnpRPC_NICOS_Fix_debuginfoclean

##	  /bin/rm -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) $(bin)PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies.make

install :: PhysicsAnpRPC_NICOS_Fix_debuginfoinstall ;

PhysicsAnpRPC_NICOS_Fix_debuginfoinstall :: $(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies) $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : PhysicsAnpRPC_NICOS_Fix_debuginfouninstall

$(foreach d,$(PhysicsAnpRPC_NICOS_Fix_debuginfo_dependencies),$(eval $(d)uninstall_dependencies += PhysicsAnpRPC_NICOS_Fix_debuginfouninstall))

PhysicsAnpRPC_NICOS_Fix_debuginfouninstall : $(PhysicsAnpRPC_NICOS_Fix_debuginfouninstall_dependencies) ##$(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile); then \
	  $(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_PhysicsAnpRPC_NICOS_Fix_debuginfo_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: PhysicsAnpRPC_NICOS_Fix_debuginfouninstall ;
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(PhysicsAnpRPC_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(PhysicsAnpRPC_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_compile = $(bin)$(PhysicsAnpRPC_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(PhysicsAnpRPC_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(PhysicsAnpRPC_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(PhysicsAnpRPC_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(PhysicsAnpRPC_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(PhysicsAnpRPC_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(PhysicsAnpRPC_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(PhysicsAnpRPC_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(PhysicsAnpRPC_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(PhysicsAnpRPC_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(PhysicsAnpRPC_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(PhysicsAnpRPC_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(PhysicsAnpRPC_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(PhysicsAnpRPC_tag).make

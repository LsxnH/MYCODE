...
#
#   Generated Thu Jun 15 10:51:01 2017  by hengli
#
#====================================
...
#cmt_local_tagfile_install_python_modules = $(PhysicsAnpRPC_tag)_install_python_modules.make
...
#cmt_local_tagfile_install_python_modules = $(PhysicsAnpRPC_tag).make
...
#cmt_final_setup_install_python_modules = $(bin)PhysicsAnpRPC_install_python_modulessetup.make
...
#cmt_final_setup_install_python_modules = $(bin)PhysicsAnpRPCsetup.make
cmt_local_install_python_modules_makefile = $(bin)install_python_modules.make
...
install_dir = ${installarea}/python/PhysicsAnpRPC
...
PhysicsAnpRPCEff_py_dependencies = ../python/PhysicsAnpRPCEff.py
...
${install_dir}/__init__.py :: ../python/__init__.py
	@if test ! "${installarea}" = ""; then \
	  ...
	  $(cmt_install_action) "$${d}" "__init__.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.30/AthAnalysisBase/2.4.30/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi
...
install_python_modulesinstall :: ${install_dir}/PhysicsAnpRPCEff.py ;

${install_dir}/PhysicsAnpRPCEff.py :: ../python/PhysicsAnpRPCEff.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/PhysicsAnpRPCEff.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "PhysicsAnpRPCEff.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/AthAnalysisBase/x86_64-slc6-gcc49-opt/2.4.30/AthAnalysisBase/2.4.30/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi

../python/PhysicsAnpRPCEff.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "PhysicsAnpRPCEff.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi

...
p.add_option('--min-sector-nden',     type='int',    default=1000,          dest='min_sector_nden')
p.add_option('--min-sector-nnum',     type='int',    default=1,             dest='min_sector_nnum')
p.add_option('--min-panel-nden',      type='int',    default=25,            dest='min_panel_nden')
p.add_option('--min-panel-nnum',      type='int',    default=1,             dest='min_panel_nnum')

p.add_option('--min-layer-pp-hits',   type='float',  default=0.20,          dest='min_layer_pp_hits')
